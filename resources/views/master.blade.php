...
<head>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a href="{!! URL('home') !!}" class="brand">
                        <img src="{{ url('public/lib/images/logoevn.png')}}" width="30px" height="50px" style="margin-top:-4px">DACN
                    </a>
        ...
        <footer class="application-footer">
            <div class="container">
                        <b> <p>Đồ án chuyên ngành quản lý kho</p></b>
                        <div class="disclaimer">
                            <p>Địa chỉ: Thủ Dầu Một, Bình Dương</p>
                            <p>Điện thoại:0868896944 </p>
                        </div>
            </div>
        </footer>
	</body>
